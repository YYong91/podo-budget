...
export default function FloatingActionButton() {
  ...
  return (
    <div ref={ref} className="fixed bottom-[calc(3.5rem+env(safe-area-inset-bottom,0px)+0.75rem)] md:bottom-6 right-4 md:right-6 z-40 flex flex-col items-end gap-3">
      {/* 팝오버 메뉴 */}
      {open && (
