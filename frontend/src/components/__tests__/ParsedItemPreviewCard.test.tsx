...
describe('ParsedItemPreviewCard', () => {
  ...
  describe('필드 업데이트', () => {
    ...
    it('카테고리 변경 시 onUpdate를 호출한다', () => {
      const onUpdate = vi.fn()
      const categories = [{ id: 1, name: '식비', type: 'expense' as const, description: null, emoji: null, sort_order: 1, is_savings: false, is_system: true, exclude_auto_payment: false, created_at: '' }]
      render(
        <ParsedItemPreviewCard
          {...defaultProps}
