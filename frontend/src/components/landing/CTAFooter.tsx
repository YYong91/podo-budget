      ...
      >
        ...
        >
          ...
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row">
            ...
            <button type="button" onClick={준비중} className="flex items-center gap-2 rounded-xl border-2 border-white/30 bg-transparent px-6 py-3.5 font-medium text-white transition-all hover:bg-white/10">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-cream/60">
              ...
              <button type="button" onClick={준비중} className="transition-colors hover:text-cream">
                자주 묻는 질문
              </button>
              <button type="button" onClick={준비중} className="transition-colors hover:text-cream">
                문의하기
            ...
            <div className="flex items-center gap-4">
              <button type="button" onClick={준비중} className="flex h-10 w-10 items-center justify-center rounded-full bg-cream/10 text-cream/60 transition-colors hover:bg-cream/20 hover:text-cream">
