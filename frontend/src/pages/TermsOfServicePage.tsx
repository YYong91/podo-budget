...
export default function TermsOfServicePage() {
  return (
    <div className="min-h-screen bg-[var(--surface)]">
      {/* 헤더 */}
      <header className="bg-[var(--surface-card)] border-b border-[var(--border-default)] sticky top-0 z-10">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-[var(--surface-card)] rounded-2xl shadow-sm border border-[var(--border-default)] p-6 sm:p-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-[var(--text-primary)] mb-6">
            이용약관
          </h1>

          <div className="prose prose-sm sm:prose max-w-none space-y-6 text-[var(--text-secondary)]">
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">제1조 (목적)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">제2조 (서비스의 내용)</h2>
              <p className="mb-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">제4조 (이용자의 의무)</h2>
              <p className="mb-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">제5조 (서비스 제공자의 의무 및 책임 제한)</h2>
              <ol className="list-decimal list-inside space-y-2 ml-4">
                <li>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">제6조 (서비스의 변경 및 중단)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">제7조 (지적재산권)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">제8조 (면책 조항)</h2>
              <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">제9조 (회원 탈퇴 및 계정 삭제)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">제10조 (약관의 변경)</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">제11조 (준거법 및 관할)</h2>
              <p>
