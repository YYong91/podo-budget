        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-[var(--surface-card)] rounded-2xl shadow-xl w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-5 space-y-4">
              ...
              {!editingId && (
                <div>
                  <label className="block text-sm font-medium text-[var(--text-secondary)] mb-1">유형</label>
                  <div className="flex gap-2">
                    <button
                      type="button"
              ...
              {/* 금액 */}
              <div>
                <label className="block text-sm font-medium text-[var(--text-secondary)] mb-1">금액</label>
                <input
                  type="number"
              ...
              {!editingId && (
                <>
                  <div>
                    <label className="block text-sm font-medium text-[var(--text-secondary)] mb-1">반복 빈도</label>
                    <select
                  ...
                  {(formData.frequency === 'monthly' || formData.frequency === 'yearly') && (
                    <div>
                      <label className="block text-sm font-medium text-[var(--text-secondary)] mb-1">반복일</label>
                      <input
                        type="number"
                  ...
                  {formData.frequency === 'weekly' && (
                    <div>
                      <label className="block text-sm font-medium text-[var(--text-secondary)] mb-1">요일</label>
                      <select
                  ...
                  {formData.frequency === 'yearly' && (
                    <div>
                      <label className="block text-sm font-medium text-[var(--text-secondary)] mb-1">반복 월</label>
                      <select
                  ...
                  {formData.frequency === 'custom' && (
                    <div>
                      <label className="block text-sm font-medium text-[var(--text-secondary)] mb-1">반복 주기 (일)</label>
                      <input
                        type="number"
                  ...
                  {/* 시작일 */}
                  <div>
                    <label className="block text-sm font-medium text-[var(--text-secondary)] mb-1">시작일</label>
                    <input
                      type="date"
              ...
              {/* 종료일 (항상 표시) */}
              <div>
                <label className="block text-sm font-medium text-[var(--text-secondary)] mb-1">종료일 (선택)</label>
                <input
                  type="date"
