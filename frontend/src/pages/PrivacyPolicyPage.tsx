      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-[var(--surface-card)] rounded-2xl shadow-sm border border-[var(--border-default)] p-6 sm:p-8">
          ...
          <div className="prose prose-sm sm:prose max-w-none space-y-6 text-[var(--text-secondary)]">
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">1. 개인정보의 수집 항목 및 방법</h2>
              <p className="mb-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">2. 개인정보의 수집 및 이용 목적</h2>
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>회원 가입 및 본인 인증</li>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">3. 개인정보의 제3자 제공</h2>
              <p className="mb-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">4. 개인정보의 보유 및 이용 기간</h2>
              <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">5. 개인정보의 파기 절차 및 방법</h2>
              <p className="mb-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">6. 사용자 및 법정대리인의 권리</h2>
              <p className="mb-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">7. 개인정보 보호책임자</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">8. 개인정보처리방침의 변경</h2>
              <p>
