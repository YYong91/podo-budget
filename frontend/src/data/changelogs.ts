...
export const changelogs: Changelog[] = [
  {
    ...
    items: [
      ...
      { tag: '개선', text: '결제수단 관리 화면 디자인을 다른 설정 화면과 통일' },
      { tag: '개선', text: '기본 결제수단을 편집 모드에서 별 아이콘으로 간편하게 설정' },
    ],
  },
  {
    version: '0.25.0',
  ...
  },
  {
    ...
    items: [
      ...
      { tag: '개선', text: '가계부 홈·모아보기 상단 지출 라벨이 예산 상태에 따라 달라집니다 (예: 예산을 넘었어요, 지출 속도가 빨라요)' },
