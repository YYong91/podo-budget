...
시스템 결제수단(is_system=True): 전체 사용자 공유, household_id=NULL, created_by=NULL.
"""
...
class PaymentMethod(Base):  # type: ignore[misc]
    ...
    Attributes:
        ...
        household_id: 소속 가구 ID (시스템 결제수단은 NULL)
        created_by: 결제수단을 생성한 사용자 ID (시스템 결제수단은 NULL)
        ...
        is_system: 시스템 기본 결제수단 여부 (전체 공유, 수정/삭제 불가)
    ...
    is_system = Column(Boolean, nullable=False, default=False, server_default="0")  # 시스템 기본 결제수단 (전체 공유, 수정/삭제 불가)
