        ...
        resend.Emails.send(
            {
                "from": settings.RESEND_FROM_EMAIL,
                "to": [to_email],
                "subject": "HomeNRich 비밀번호 재설정",
                "html": f"""
            <div style="font-family: 'Apple SD Gothic Neo', 'Noto Sans KR', sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px;">
                <h2 style="color: #292524; margin-bottom: 16px;">비밀번호 재설정</h2>
                <p style="color: #57534e; font-size: 16px; line-height: 1.6;">
                ...
                <p style="color: #a8a29e; font-size: 14px;">요청하지 않으셨다면 이 이메일을 무시하세요. 링크는 1시간 후 만료됩니다.</p>
            </div>
            """,
            }
        )
