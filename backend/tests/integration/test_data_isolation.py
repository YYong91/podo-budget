...
async def test_expense_data_isolation_list(
    ...
    expense1 = Expense(user_id=test_user.id, household_id=test_household.id, amount=10000, description="User1 지출", date=datetime.now())
    expense2 = Expense(user_id=test_user2.id, household_id=test_household2.id, amount=20000, description="User2 지출", date=datetime.now())
...
async def test_expense_data_isolation_detail(
    ...
    expense = Expense(user_id=test_user2.id, household_id=test_household2.id, amount=20000, description="User2 지출", date=datetime.now())
...
async def test_monthly_stats_data_isolation(
    ...
    """월별 통계는 자신의 지출만 집계됨"""
    expense1 = Expense(user_id=test_user.id, household_id=test_household.id, amount=10000, description="User1 지출", date=datetime(2026, 2, 15))
    expense2 = Expense(user_id=test_user2.id, household_id=test_household2.id, amount=50000, description="User2 지출", date=datetime(2026, 2, 15))
    db_session.add_all([expense1, expense2])
    await db_session.commit()
