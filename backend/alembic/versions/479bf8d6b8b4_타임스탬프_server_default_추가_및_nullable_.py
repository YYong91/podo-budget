...
down_revision: str | Sequence[str] | None = "e0127bcbd625"
...
def upgrade() -> None:
    ...
    with op.batch_alter_table("accounts", schema=None) as batch_op:
        batch_op.alter_column("created_at", existing_type=sa.DATETIME(), server_default=sa.text("(CURRENT_TIMESTAMP)"), nullable=False)
        batch_op.alter_column("updated_at", existing_type=sa.DATETIME(), server_default=sa.text("(CURRENT_TIMESTAMP)"), nullable=False)
    ...
    with op.batch_alter_table("household_members", schema=None) as batch_op:
        batch_op.alter_column("joined_at", existing_type=sa.DATETIME(), server_default=sa.text("(CURRENT_TIMESTAMP)"), existing_nullable=False)
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("accounts", schema=None) as batch_op:
        batch_op.alter_column("updated_at", existing_type=sa.DATETIME(), server_default=None, nullable=True)
        batch_op.alter_column("created_at", existing_type=sa.DATETIME(), server_default=None, nullable=True)
    ...
    with op.batch_alter_table("household_members", schema=None) as batch_op:
        batch_op.alter_column("joined_at", existing_type=sa.DATETIME(), server_default=None, existing_nullable=False)
